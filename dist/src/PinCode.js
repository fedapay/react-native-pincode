...
class PinCode extends React.PureComponent {
    constructor(props) {
        ...
        this.renderButtonNumber = (text) => {
            ...
            //   }}>
            //   {({ opacity }: any) => (
            React.createElement(react_native_1.TouchableHighlight, { style: [
                    styles.buttonCircle,
        ...
        this.renderButtonDelete = (opacity) => {
            return (React.createElement(react_native_1.TouchableHighlight, { activeOpacity: 1, disabled: this.state.password.length === 0, underlayColor: "transparent", onHideUnderlay: () => this.setState({
                ...
                React.createElement(react_native_1.View, { style: [styles.colIcon, this.props.styleColumnDeleteButton] }, this.props.customBackSpaceIcon ?
                    ...
                    :
                        React.createElement(React.Fragment, null, !this.props.iconButtonDeleteDisabled && (React.createElement(MaterialIcons_1.default, { name: this.props.styleDeleteButtonIcon, size: this.props.styleDeleteButtonSize, color: this.state.colorDelete, style: { opacity: opacity } }))))));
        };
        ...
        return (React.createElement(react_native_1.View, { style: [
            ...
            React.createElement(react_native_1.View, { style: [
                ...
                this.props.titleComponent
                    ? this.props.titleComponent()
                    : this.renderTitle(this.props.styleColorTitle, 1, attemptFailed, showError),
                this.props.subtitleComponent
                    ? this.props.subtitleComponent()
                    : this.renderSubtitle(this.props.styleColorSubtitle, 1, attemptFailed, showError)),
